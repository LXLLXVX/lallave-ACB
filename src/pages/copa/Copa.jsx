        ...
        <>
            ...
            <div className="copa-container">
                ...
                <div className="copa-container-left">
                    <h1>Noticias de Interés - Copa del rey 2024/2025</h1>

                    <div className="section" id="new-1">
                        <h2>MVP Movistar</h2>
                    ...
                    <div className="section" id="new-2">
                    ...
                    <div className="section" id="new-3">
                    ...
                    <div className="section" id="new-4">
                    ...
                    <div className="section" id="new-5">
                        <h2>Historias</h2>
                    ...
                    <div className="section" id="new-6">
                        <h2>Debutantes</h2>
                    ...
                    <div className="section" id="new-7">
                        <h2>Estadísticas</h2>
                ...
                <a href='\public\rss.xml'>
                <img src="\images\rss.png" alt="rss" className="rss-image" />
                </a>
